-- Statement timeouts on text search: multiple UNION branches scanned cards_v2 repeatedly and
-- ignored p_game_id / p_expansion_id until late. One pass on cards_v2 with early filters + EXISTS for set.
